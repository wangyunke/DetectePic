...
public abstract class LoadingLayout extends FrameLayout implements
	...
	protected GifDrawable gifFromResource=null;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case VERTICAL:
		default:
			LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header_vertical_two, this);
			break;
		}
...
//----------------end------------------------------
	...
	public final void refreshing() {
		try {
			mHeaderImage.setImageDrawable(new GifDrawable(getResources(), R.drawable.de));
		} catch (IOException e) {
			e.printStackTrace();
		}

		/*mHeaderImage.setImageDrawable(getResources().getDrawable(R.drawable.default_ptr_flip));
		if (null != mHeaderText) {
